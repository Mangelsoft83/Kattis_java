...
public class hopper_connect {
    ...
    private static int dfs(int[] arr, int m, int d,boolean print) {
        ...
        ArrayList<ArrayList> Mapping = createMapping(arr, m, d, print);
    ...
    private static ArrayList<ArrayList> createMapping(int[] arr, int m, int d, boolean print) {
        int n = arr.length;
        int longestPath;
        ...
        if(print) {
            ...
            for (int i = 0; i < mapping.size(); i++) {
                System.out.print("index: " + i + "\t N:" + arr[i] + "\t:   " );
                ArrayList<Integer> indMap = mapping.get(i);
                for (Integer integer : indMap) {
                    System.out.print(integer + " ");
                }
